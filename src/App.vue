            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li class="nav-item"><a class="nav-link" :class="{ active: homeCurrnent}" @click="setCurrent('home')" aria-current="page" href="Flash_PWA/#/">Home</a></li>
                        <li class="nav-item"><a class="nav-link" :class="{ active: flashesCurrent}" @click="setCurrent('flashes')" href="Flash_PWA/#/flashes">Flashes</a></li>
                        <li class="nav-item"><a class="nav-link" :class="{ active: siteInfoCurrnent}" @click="setCurrent('siteInfo')" href="Flash_PWA/#/siteInfo">Site Info</a></li>
